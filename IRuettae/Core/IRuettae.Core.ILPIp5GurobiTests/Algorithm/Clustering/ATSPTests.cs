...
using IRuettae.Core.ILPIp5Gurobi.Algorithm.Clustering;
using IRuettae.Core.ILPIp5Gurobi.Algorithm.Models;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using SolverInputData = IRuettae.Core.ILPIp5Gurobi.Algorithm.Clustering.SolverInputData;

namespace IRuettae.Core.ILPIp5Gurobi.Tests.Algorithm.Clustering
{
    [TestClass]
